...
class DocPresenter extends Presenter
{
    ...
    /**
     * Get the previous doc of the current doc
     * @return object
     */
    public function previous()
    {
        return $this->doc->getPreviousOf($this->entity);
    }

    /**
     * Get the next doc of the current doc
     * @return object
     */
    public function next()
    {
        return $this->doc->getNextOf($this->entity);
    }
