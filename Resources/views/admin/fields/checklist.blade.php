...
@push('crud_fields_styles')
        <!-- include select2 css
<link href="{{ asset('modules/idocs/vendor/checkbox-inline/checkbox-inline.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('modules/idocs/vendor/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css') }}" rel="stylesheet" type="text/css" />-->
@endpush
